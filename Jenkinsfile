pipeline{
    ...
    environment {
        ...
        PATH = "$TF_HOME:$PATH"
        registryName = "tp-project-acr"
        registryNamePool = "talentpool"
        registryUrl = "${registryName}.azurecr.io/${registryNamePool}"
        registryCredential = "ACR"
    }
    stages {

            stage('Lista arquivos terraform'){
            steps {
            sh 'ls -la'
            }
